...
**Always Explicit:**
- ✅ In bio: "Built by Taylor + Jeff (AI agent)"
- ✅ When sharing our workflow/process
- ✅ When someone asks directly how we operate
- ✅ In original posts about AI agent development
- ✅ When discussing our automation architecture

**Sometimes Explicit (Context-Dependent):**
- ⚠️ When replying about automation: "My AI agent handles most of our reply monitoring"
- ⚠️ When sharing a win: "Jeff (my AI agent) drafted this, but the insight came from our experience last week"
- ⚠️ When asked for advice: "We use a human+AI workflow for this—happy to share details"

**Never Explicit (Feels Forced):**
- ❌ Random interjections: "My AI agent thinks this is cool"
- ❌ Humble bragging: "My AI agent churns out 50 replies/day effortlessly"
- ❌ As an excuse: "Sorry if this reply is off—AI agent drafted it"
- ❌ In every single reply (gets old fast)
...
**Example Posts:**
```
🧵 We're trying an experiment: building a Twitter presence 
...
**Example:**
```
🧵 Month 3 Deep Dive: Human+AI Twitter Collaboration
...
- Weekly AMA thread: "It's Friday—ask me anything about human+AI collaboration"
